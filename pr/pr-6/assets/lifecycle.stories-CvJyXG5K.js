import{i as e}from"./preload-helper-B45gAKPr.js";import{ft as t,pt as n,ut as r}from"./iframe-CqVTJ8_o.js";import{l as i}from"./src-BVV7ohPG.js";import{t as a}from"./cosmoz-slideout-panel-D522LWGK.js";var o,s,c,l,u;e((()=>{i(),n(),a(),{expect:o,waitFor:s}=__STORYBOOK_MODULE_TEST__,c={title:`CosmozSlideoutPanel/Lifecycle`,component:`cosmoz-slideout-panel`,tags:[`autodocs`]},l={render:()=>{let e=document.createElement(`div`),n=document.createElement(`ol`);n.dataset.testid=`event-log`,n.style.cssText=`margin: calc(var(--cz-spacing) * 3) 0 0; color: var(--cz-color-text-tertiary); font-family: var(--cz-font-body); font-size: var(--cz-text-sm);`;let i=e=>{let t=document.createElement(`li`);t.textContent=e,n.append(t)},a=!1,o=()=>r(t`
